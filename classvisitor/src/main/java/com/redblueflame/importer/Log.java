...
public class Log {
    private static final HashMap<Integer, String> accCodeMap = new HashMap<>();
    private static final HashMap<Integer, String> opCodeMap = new HashMap<>();

    public static void logEach(Object... obj) {
        for (Object object : obj) {
            System.out.println(object);
        }
    }

    public static String getStrFromAccCode(int code) {
